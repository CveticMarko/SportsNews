              ...
              <div class="navbar-bottom-menu">
                ...
                >
                  ...
                  >
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="Valleyball.php">World</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="author.php">Magazine</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="SinglePost.php">Blog</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="Hockey.php">Business</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="Tennis.php">Sports</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="Motorsport.php">Art</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="Footbal.php">Politics</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="Boxing.php">Real estate</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="Basketball.php">Travel</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="row">
              ...
              <div class="col-sm-3 col-lg-3">
                <ul class="footer-vertical-nav">
                  <li class="menu-title"><a href="SinglePost.php">News</a></li>
                  <li><a href="../index.html">Home</a></li>
                  <li><a href="Valleyball.php">World</a></li>
                  <li><a href="author.php">Magazine</a></li>
                  <li><a href="Hockey.php">Business</a></li>
                  <li><a href="Footbal.php">Politics</a></li>
                </ul>
              </div>
              <div class="col-sm-3 col-lg-3">
                <ul class="footer-vertical-nav">
                  <li class="menu-title"><a href="Valleyball.php">World</a></li>
                  <li><a href="Tennis.php">Sports</a></li>
                  <li><a href="Motorsport.php">Art</a></li>
                  <li><a href="#">Magazine</a></li>
                  <li><a href="Boxing.php">Real estate</a></li>
                  <li><a href="Basketball.php">Travel</a></li>
              ...
              <div class="col-sm-3 col-lg-3">
                <ul class="footer-vertical-nav">
                  ...
                  <li><a href="SinglePost.php">Newsletters</a></li>
